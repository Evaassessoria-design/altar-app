...
const Assistente = lazy(() => import("./pages/app/assistente/page.tsx"));
// Escritório ≠ Assistente: este é o painel interno do negócio ALTAR, atrás de
// `requirePlatformOwner`. A rota existir não abre nada — o backend é que trava.
